    ...
    useEffect(() => {
        if (!isDisconnected) {
            ...
            const getGoerliRedeemablePayments = async () => {
                ...
                const contractGoerli = new ethers.Contract(PaylockAddressGoerli.PaylockAddress, PayFactory.abi, provider);
                    ...
                    <React.Fragment>
                        {isConnected ?
                            <>
                                                    ...
                                                    {transaction.state == 0 &&
                                                        <React.Fragment>
                                                            ...
                                                            <button
                                                                ...
                                                                onClick={() => {
                                                                    withdrawIssuerPaymentMumbai(transaction.code, parseInt(transaction.receiverId._hex))
                                                    ...
                                                    {transaction.state == 0 &&
                                                        <React.Fragment>
                                                            ...
                                                            <button
                                                                disabled={transactionLoading}
                                                                onClick={() => {
                                                                    withdrawIssuerPaymentGoerli(transaction.code, parseInt(transaction.receiverId._hex))
                                                                }} className={`w-full  p-2 self-center  bg-[#1e1d45] dark:bg-[#100d23] text-[#c24bbe] text-sm `}>
                                                                {transactionLoading &&
                                                                    <Image
                                                                        className={`animate-spin inline`}
                                ...
                                {mumbaiIssuedPayments.length == 0 && goerliIssuedPayments.length == 0 &&
                                    <span className={`
                                 col-start-1 col-end-8 row-start-2 row-end-3
                                 bg-[aliceblue] dark:bg-[#1e1d45]
                                grid grid-cols-[repeat(4,1fr)] grid-rows-[1]`
