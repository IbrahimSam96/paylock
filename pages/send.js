...
const Send = () => {
    ...
    return (
        ...
        <div className={`h-full min-h-screen w-full grid grid-cols-[repeat(7,1fr)] grid-rows-[100px,25px,auto,100px] bg-[#131341]`}>
            ...
            <span className={` self-center col-start-1 col-end-8 mx-4 grid  `}>

                <span className={`text-[#149adc] text-lg flex `} >
                    <Image
                        width={30}
                        height={30}
                        className={`inline `}
                ...
                <span className={` flex self-center justify-self-end`}>
                    ...
                    <svg className={`cursor-pointer hover:opacity-80 ml-2 `} width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {!isSSR &&
                <React.Fragment>
                    <span className={`rounded-2xl justify-self-auto sm:justify-self-center self-center col-start-1 col-end-8 row-start-3 row-end-4 sm:mx-4 p-4  grid grid-rows-[40px,min-content,30px,30px,40px,30px,30px,min-content,50px] grid-cols-1 border-black border-[2px] bg-[#100d23] mr-20 sm:mr-0   `}>
                        ...
                        >
                            ...
                            <AccordionDetails>
                                <div className={` border-[1px]  border-[#1e1d45] rounded sm:px-2`}>
                                    <span className={`flex  `}>
                                        <span className={`font-bold text-xs  text-[#372963] self-center`}
                                        >Sending:
                                        </span>
                                        <span className={`flex border-[1px] cursor-pointer border-[#372963] rounded sm:px-2 sm:m-2 `}>

                                            <Avatar className="w-8 h-8 inline self-center ml-2" {...config.current} />
                                            <input
                                                name="name"
                                                type="text"
                                                className={`sm:ml-2 self-center justify-self-start text-[#c24bbe] `}
